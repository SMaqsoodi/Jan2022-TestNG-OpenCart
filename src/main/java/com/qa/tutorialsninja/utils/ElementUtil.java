...
// Constructor method of the class		
	...
	public List<WebElement> getWebTableItems(String firstPartPath, String secondPartPath, int rowCount) {
	
		String finalPath;
		List<WebElement> itemsInfo = new ArrayList();
		
		for(int rowNum=1; rowNum<=rowCount; rowNum++) {
			finalPath = firstPartPath+rowNum+secondPartPath;
			System.out.println(finalPath);
			itemsInfo.add(driver.findElement(By.xpath(finalPath)));
